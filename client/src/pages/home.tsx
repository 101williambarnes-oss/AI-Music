  ...
  return (
    <div className="hwm-app">
      ...
      <section className="hero" data-testid="section-hero">
        ...
        <div style={{ position: "relative", zIndex: 3, color: "#6cf0ff", fontSize: 16, fontWeight: 600, letterSpacing: 3, textTransform: "uppercase", marginTop: 6, textAlign: "center", textShadow: "0 0 12px rgba(108,240,255,.5)" }} data-testid="text-tagline">The Home of AI Music</div>
      </section>
